...
export const environment = {
  ...
  auth0: {
    url: 'https://fsnd-coffeeshop.auth0.com/', // the auth0 domain prefix
...
// &client_id=Rt5U5ELQnj9UiVvDsHzvLSF32udYDoC8&redirect_uri=http://localhost:8100/tabs/drink-menu
